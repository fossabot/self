...
// Removed unused direct jj2000 imports; we rely on org.jmrtd.jj2000.JJ2000Decoder
...
object ImageUtil {
    ...
    fun decodeImage(inputStream: InputStream, imageLength: Int, mimeType: String): Bitmap {
        ...
        if (WSQ_MIME_TYPE.equals(mimeType, ignoreCase = true)) {
            ...
            // For JPEG2000 and other unsupported formats, fallback to BitmapFactory
            // Note: JPEG2000 is not natively supported by Android; callers should avoid JP2 here
