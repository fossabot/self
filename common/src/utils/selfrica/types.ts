...
export const serializeSmileData = (smileData: SmileData) => {
  ...
  let serializedData = '';
  smileData.country = smileData.country
    .toUpperCase()
    .padEnd(constants.SELFRICA_COUNTRY_LENGTH, '\0');
  ...
  smileData.issuanceDate = smileData.issuanceDate.padEnd(
    constants.SELFRICA_ISSUANCE_DATE_LENGTH,
    '\0'
  );
  ...
  smileData.phoneNumber = smileData.phoneNumber.padEnd(
    constants.SELFRICA_PHONE_NUMBER_LENGTH,
    '\0'
  );
